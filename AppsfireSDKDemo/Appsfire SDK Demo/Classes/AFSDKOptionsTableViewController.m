//
//  AFSDKOptionsTableViewController.m
//  Appsfire SDK Demo
//
...
#import "AFNotificationBarExampleController.h"
...
@interface AFSDKOptionsTableViewController ()
...
@implementation AFSDKOptionsTableViewController
    ...
    switch (indexPath.section) {
        ...
        case AppsfireSDKSectionUIIntegration: {
            switch (indexPath.row) {
                ...
                case AppsfireSDKUIIntegrationRowBarView: {
                    AFNotificationBarExampleController *notificationBarExampleController = [[AFNotificationBarExampleController alloc] init];

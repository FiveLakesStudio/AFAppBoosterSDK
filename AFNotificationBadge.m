...
{
    return [[self alloc] initWithString:badgeString withScale:1.0 withShining:YES withRectFrame:rect];
} // customBadgeWithString

// Creates a Badge with a given Text 
+ (AFNotificationBadge*) customBadgeWithString:(NSString *)badgeString
{
	return [[self alloc] initWithString:badgeString withScale:1.0 withShining:YES withRectFrame:CGRectMake(0, 0, 25, 25)];
}
